...
public class JBlasVector3D implements Vector{
   ...
   @Override   
	...
	@Override
	public void setInternalVector(Object internalVector) {
		this.internalVector = (DoubleMatrix) internalVector;
	}
	@Override
